...
class DaresDBOpenHelper(
    ...
    fun addDare(dare: dare) {
        ...
        values.put(COLUMN_DRINK_BOOL, dare.drinkBool)
    ...
    fun getAllDares(): ArrayList<dare> {
        ...
        if (cursor!!.moveToFirst()) {
            while (cursor.isAfterLast == false) {
                ...
                drinkBool = cursor.getInt(cursor.getColumnIndex(COLUMN_DRINK_BOOL))
                dares.add(dare(id, dareText, amount, drinkAmount, drinkBool))
                cursor.moveToNext()
            }
        }
        cursor.close()
    ...
    fun getSpecificDareById(id: Int): dare {
        ...
        if (cursor!!.moveToFirst()) {
            dare = dare(
                ...
                cursor.getInt(cursor.getColumnIndex(COLUMN_DRINK_BOOL))
            )
        }
        cursor.close()
        db.close()
...
//        val db = this.writableDatabase
        ...
        values.put(COLUMN_DRINK_BOOL, drinkBool)
        dareTexts.forEach {
    ...
    companion object {
        ...
        const val COLUMN_DRINK_BOOL = "drinkBool"
    }
